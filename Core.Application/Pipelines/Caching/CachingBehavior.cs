    ...
    where TRequest : IRequest<TResponse>, ICachableRequest
{
    ...
    public async Task<TResponse> Handle(TRequest request, RequestHandlerDelegate<TResponse> next, CancellationToken cancellationToken)
    {
        ...
        if (cachedResponse != null)
        {
            ...
            _logger.LogInformation($"Ön bellekten çekildi -> {request.CacheKey}");
        }
        else
        {
        ...
        CancellationToken cancellationToken)
    {
        ...
        _logger.LogInformation($"Ön belleğe eklendi -> {request.CacheKey}");
    ...
    private async Task addCacheKeyToGroup(TRequest request, TimeSpan slidingExpiration, CancellationToken cancellationToken)
    {
        ...
        _logger.LogInformation($"Ön belleğe eklendi -> {request.CacheGroupKey}");
        ...
        _logger.LogInformation($"Ön belleğe eklendi -> {request.CacheGroupKey}SlidingExpiration");
    }
}
